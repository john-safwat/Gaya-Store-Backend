...
<body>
    ...
    <form action="{{route("updateBrand" , $brand->id)}}" method="POst" class="container brand-input-form">
        @csrf

        <input type="text" name="name" id="" placeholder="Brand Name" class="Brand-Input" value="{{$brand->name}}">
        <input type="text" name="country" id="" placeholder="Country of Origin" class="Brand-Input" value="{{$brand->country}}">
        <input type="submit" id="" value="Edit" class="submitbutton">
    </form>
</body>
</html>
